...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    {Spule \\ 2000 m};
    \draw (sp4.base) node [shape=rectangle, draw, align=center, below] (bert)
    at +(-30mm, 0) {Oszilloskop \&  \\ Signalgenerator};

    % Verbindungen %
    \coordinate (pivot1) at ($ (bert) + (0, -20mm) $);
